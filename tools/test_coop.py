...
# mmengine.dist is the correct location (mmcv.runner was removed in mmcv2)
try:
...
# mmengine.parallel is the correct location (mmcv.parallel was removed in mmcv2)
try:
...
# mmengine.runner is the correct location (mmcv.runner was removed in mmcv2)
try:
    ...
    def wrap_fp16_model(model):
        return model
# DictAction is in mmengine.config, not mmengine.utils
try:
    from mmengine.config import DictAction
except ImportError:
    # Fallback: simple DictAction implementation
