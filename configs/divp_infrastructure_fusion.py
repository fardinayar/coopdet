# Infrastructure-only Fusion Configuration
# Camera + LiDAR fusion for infrastructure only (non-cooperative)
...
# Model configuration - Single agent (infrastructure)
model = dict(
...
# Override dataset to use infrastructure-only data
train_dataloader = dict(
    dataset=dict(
        type='DIVPNuscDataset',
        # Filter to infrastructure-only samples
