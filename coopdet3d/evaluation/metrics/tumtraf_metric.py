...
"""TUMTraf V2X evaluation metric.

This module provides comprehensive evaluation for TUMTraf V2X cooperative perception dataset.
...
class TUMTrafMetric(BaseMetric):
    ...
    on the TUMTraf V2X dataset using both NuScenes-style and KITTI-style protocols.
