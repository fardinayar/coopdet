...
def get_logger(name="mmdet3d", log_file=None, log_level=logging.INFO):
    """Get logger using mmengine MMLogger."""
    logger = MMLogger.get_instance(name=name, log_file=log_file, log_level=log_level)
    return logger
